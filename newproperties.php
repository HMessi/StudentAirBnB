<?php
require 'include/newproperties.php';
?>
                        ...
                        <form method="POST">
                            ...
                            <div class="search-contents-sidebar">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="propertytitle" class="input-text" name="your name" placeholder="Property Title">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input type="text" name="propertyprice" class="input-text" name="your name" placeholder="MYR">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Area/Location</label>
                                            <input type="text" name="area" class="input-text" name="your name" placeholder="Pelangi Utama Condo">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button name="publish" class="btn button-md button-theme">Publish property</button>
                                </div>
                            </div>
                        </form>
                    </div>
